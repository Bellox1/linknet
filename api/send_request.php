...
require_once __DIR__ . '/../vues/back-office/config/database.php';
require_once __DIR__ . '/../vues/clients/includes/functions.php'; // Pour sendNotification
        ...
        if ($action === 'add') {
            ...
            if ($stmt->execute([$currentUserId, $userId])) {
                ...
                if (function_exists('sendNotification')) {
                    sendNotification($conn, $userId, $currentUserId, 'friend_request');
                }
