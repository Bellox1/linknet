            ...
            <div class="swiper-wrapper">
                <?php foreach ($featured_posts as $featured): ?>
                    <div class="swiper-slide">
                        <img src="/vues/back-office/uploads/<?= $featured['media'] ?>" alt="Featured Image">
        ...
        <?php foreach ($posts as $post): ?>
            <div class="post">
                <div class="post-header">
                    <img src="/vues/back-office/uploads/<?= $post['profile_picture'] ?>" alt="Profile" class="profile-pic">
                ...
                <?php if ($post['media']): ?>
                    <div class="post-media">
                        ...
                        <?php if (preg_match('/\.(jpg|jpeg|png|gif)$/i', $post['media'])): ?>
                            <img src="/vues/back-office/uploads/<?= htmlspecialchars($mediaPath) ?>" alt="Post Image">
